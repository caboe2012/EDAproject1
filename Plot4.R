...
submeter_plot <- function(){
    ...
    legend('topright', bty = 'n', xjust = '1', yjust = '0.5', lty = 'solid' , col = c('black', 'red', 'blue'), legend = c('Sub_metering_1','Sub_metering_2', 'Sub_metering_3'))
}
...
preview_png <- function(){
    ...
    library(png)
    img <- readPNG('Plot4.png', native = T)
