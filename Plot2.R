###########################################
## ExplDataAnalysis - Project 1 - Plot 2 ##
###########################################
...
GAP_line_PNG <- function() {
    # Create the line graph, designating parameters as required
    # Save to a PNG file called 'Plot2.png'
    par(mfcol = c(1,1), oma = c(1,2,0,0))
    cat('graphing \n')
...
preview_png <- function(){
    ...
    library(png)
    img <- readPNG('Plot2.png', native = T)
